...
export default {
  ...
  theme: {
    extend: {
      colors: { gold:'#d4af37', ink:'#0d0f12', panel:'#15181d', fog:'#a0a3ad', twitch:'#9146FF' },
      boxShadow: { glow:'0 0 40px rgba(212,175,55,0.25)', innerSoft:'inset 0 1px 0 rgba(255,255,255,0.04), inset 0 -1px 0 rgba(0,0,0,0.4)' },
      backgroundImage: {
