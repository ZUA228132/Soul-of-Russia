...
const IconBtn = ({children, title}) => (
  <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }} title={title} className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 transition">{children}</motion.button>
)
